...
const vertexaiImageModels: AIImageModelCard[] = [
  ...
  },
  {
    ...
    enabled: true,
    type: 'image', // 注意：由于没有 AIVideoModelCard，暂时用 image 类型
    description: 'Veo 2 是 Google 最先进的视频生成模型，能够生成高质量、逼真的视频内容。',
    organization: 'Deepmind',
    ...
    pricing: {
      units: [{ name: 'imageGeneration', rate: 0.1, strategy: 'fixed', unit: 'image' }], // 视频生成暂用图片定价
    },
  },
  {
    displayName: 'Veo 2 Fast',
    id: 'veo-2-fast-generate-001',
    enabled: true,
    type: 'image',
    description: 'Veo 2 Fast 是快速版本的视频生成模型，提供更快的生成速度。',
    organization: 'Deepmind',
    releasedAt: '2024-12-11',
    parameters: {
      aspectRatio: {
